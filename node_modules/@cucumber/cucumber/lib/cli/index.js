...
class Cli {
    ...
    async initializeFormatters({ eventBroadcaster, eventDataCollector, formatOptions, formats, supportCodeLibrary, }) {
        ...
        await bluebird_1.default.map(formats, async ({ type, outputTo }) => {
        ...
        return async function () {
            await bluebird_1.default.each(streamsToClose, (stream) => bluebird_1.default.promisify(stream.end.bind(stream))());
        };
    }
