...
const pickle_runner_1 = __importDefault(require("./pickle_runner"));
...
class Runtime {
    ...
    async runPickle(pickleId) {
        ...
        const pickleRunner = new pickle_runner_1.default({
    ...
    async start() {
        ...
        await bluebird_1.default.each(this.pickleIds, this.runPickle.bind(this));
